...
class V4itemsApi
{
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\ItemResultSet
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\ItemResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\SierraApi\Model\ItemResultSet';
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\Item, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnItemByRecordIDWithHttpInfo($id, $fields = null)
    {
        $returnType = '\SierraApi\Model\Item';
