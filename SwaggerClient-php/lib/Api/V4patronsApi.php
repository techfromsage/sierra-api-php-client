...
class V4patronsApi
{
     ...
     *
     * @param  \SierraApi\Model\PatronPatch $body post request (required)
     *
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\PatronResult
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\PatronResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAPatronRecordWithHttpInfo($body)
    {
        $returnType = '\SierraApi\Model\PatronResult';
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\Patron, HTTP status code, HTTP response headers (array of strings)
     */
    public function findAPatronByVarFieldFieldTagAndVarFieldContentWithHttpInfo($var_field_tag, $var_field_content, $fields = null)
    {
        $returnType = '\SierraApi\Model\Patron';
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\Checkout
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\Checkout, HTTP status code, HTTP response headers (array of strings)
     */
    public function getACheckoutByCheckoutIDWithHttpInfo($checkout_id, $fields = null)
    {
        $returnType = '\SierraApi\Model\Checkout';
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\Fine, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAFineRecordByFineIDWithHttpInfo($fine_id, $fields = null)
    {
        $returnType = '\SierraApi\Model\Fine';
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\Hold, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAHoldRecordByHoldIDWithHttpInfo($hold_id, $fields = null)
    {
        $returnType = '\SierraApi\Model\Hold';
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\PatronResultSet
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\PatronResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\SierraApi\Model\PatronResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SierraApi\Model\PatronResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\CheckoutResultSet
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\CheckoutResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCheckoutDataForASinglePatronRecordWithHttpInfo($id, $limit = null, $offset = null, $fields = null)
    {
        $returnType = '\SierraApi\Model\CheckoutResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SierraApi\Model\CheckoutResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\CheckoutHistoryResultSet
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\CheckoutHistoryResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\SierraApi\Model\CheckoutHistoryResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SierraApi\Model\CheckoutHistoryResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\Metadata[]
     */
    public function getMetadataList($fields = null, $language = null)
    {
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\Metadata[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getMetadataListWithHttpInfo($fields = null, $language = null)
    {
        $returnType = '\SierraApi\Model\Metadata[]';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMetadataListRequest($fields = null, $language = null)
    {
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\FineResultSet
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\FineResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\SierraApi\Model\FineResultSet';
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\HoldResultSet
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\HoldResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTheHoldsDataForASinglePatronRecordWithHttpInfo($id, $limit = null, $offset = null, $fields = null)
    {
        $returnType = '\SierraApi\Model\HoldResultSet';
     ...
     *
     * @param  int $hold_id the hold record ID (required)
     * @param  \SierraApi\Model\PatronHoldPut $body the details of the hold (required)
     * @param  string $accept_language the Accept-Language header (optional)
     *
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $id the patron record ID (required)
     * @param  \SierraApi\Model\PatronHoldPost $body details of the new hold (required)
     *
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\ErrorCode
     ...
     *
     * @param  int $id the patron record ID (required)
     * @param  \SierraApi\Model\PatronPatch $body patron request (required)
     *
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\ErrorCode
     ...
     *
     * @param  \SierraApi\Model\PatronValidation $body post request (required)
     *
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\ErrorCode
