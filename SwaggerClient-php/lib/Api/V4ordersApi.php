...
class V4ordersApi
{
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\OrderResultSet
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\OrderResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\SierraApi\Model\OrderResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SierraApi\Model\OrderResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\Order, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnOrderByRecordIDWithHttpInfo($id, $fields = null)
    {
        $returnType = '\SierraApi\Model\Order';
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\Fund, HTTP status code, HTTP response headers (array of strings)
     */
    public function getThePropertiesOfAGivenFundWithHttpInfo($acct_unit, $fund_code_num)
    {
        $returnType = '\SierraApi\Model\Fund';
