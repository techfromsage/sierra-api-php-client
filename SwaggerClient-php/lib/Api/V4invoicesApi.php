...
class V4invoicesApi
{
     ...
     * @return \SierraApi\Model\InvoiceLine
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\InvoiceLine, HTTP status code, HTTP response headers (array of strings)
     */
    public function getALineItemRecordByLineIDWithHttpInfo($login, $id, $fields = null)
    {
        $returnType = '\SierraApi\Model\InvoiceLine';
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\InvoiceResultSet
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\InvoiceResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\SierraApi\Model\InvoiceResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SierraApi\Model\InvoiceResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SierraApi\Model\InvoiceLineResultSet
     */
     ...
     * @throws \SierraApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SierraApi\Model\InvoiceLineResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTheLineItemDataForASingleInvoiceRecordWithHttpInfo($login, $id, $fields = null)
    {
        $returnType = '\SierraApi\Model\InvoiceLineResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SierraApi\Model\InvoiceLineResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
