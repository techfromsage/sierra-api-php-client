...
class AcquisitionOrder implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'login' => 'string',
        'copies' => 'int',
        'allocation' => '\SierraApi\Model\AcquisitionOrderAllocation[]',
        'vendor' => 'string',
        'price' => 'double',
     ...
     * Gets allocation
     *
     * @return \SierraApi\Model\AcquisitionOrderAllocation[]
     */
     ...
     * Sets allocation
     *
     * @param \SierraApi\Model\AcquisitionOrderAllocation[] $allocation a list of data describing how the order is allocated
     *
     * @return $this
     */
