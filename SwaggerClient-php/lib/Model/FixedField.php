...
class FixedField implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'label' => 'string',
        'value' => '\SierraApi\Model\FixedFieldVal',
        'display' => 'string'
    ];
     ...
     * Gets value
     *
     * @return \SierraApi\Model\FixedFieldVal
     */
     ...
     * Sets value
     *
     * @param \SierraApi\Model\FixedFieldVal $value the stored value of the field (can be a String, LocalDate, DateTime, Boolean, Long, or Decimal depending on the field)
     *
     * @return $this
     */
