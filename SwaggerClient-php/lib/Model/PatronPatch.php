...
class PatronPatch implements ModelInterface, ArrayAccess
{
     ...
     * Sets addresses
     *
     * @param \SierraApi\Model\Address[] $addresses a list of the patron's addresses (must include all applicable addresses for the patron)
     *
     * @return $this
     */
     ...
     * Sets phones
     *
     * @param \SierraApi\Model\Phone[] $phones a list of the patron's phone numbers (must include all applicable phone numbers for the patron)
     *
     * @return $this
     */
     ...
     * Sets patron_codes
     *
     * @param \SierraApi\Model\Codes $patron_codes a list of patron codes
     *
     * @return $this
     */
