...
class DsSettings implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'milsh_port' => 'int',
        'x_circ_settings' => '\SierraApi\Model\XClientSettings',
        'x_circ2_settings' => '\SierraApi\Model\XClientSettings',
        'message_tag' => 'string',
        'mildata_settings' => '\SierraApi\Model\MildataSettings',
        'milproto_settings' => '\SierraApi\Model\MilprotoSettings'
    ];
     ...
     *
     * @return \SierraApi\Model\XClientSettings
     */
     ...
     *
     * @param \SierraApi\Model\XClientSettings $x_circ_settings the default data service xcirc settings
     *
     * @return $this
     */
     ...
     *
     * @param \SierraApi\Model\XClientSettings $x_circ2_settings the data service xcirc2 settings
     *
     * @return $this
     */
     ...
     *
     * @return \SierraApi\Model\MildataSettings
     */
     ...
     *
     * @param \SierraApi\Model\MildataSettings $mildata_settings MILDATA settings
     *
     * @return $this
     */
     ...
     *
     * @return \SierraApi\Model\MilprotoSettings
     */
     ...
     *
     * @param \SierraApi\Model\MilprotoSettings $milproto_settings MILPROTO settings
     *
     * @return $this
     */
