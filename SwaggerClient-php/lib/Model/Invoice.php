...
class Invoice implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'inv_num' => 'string',
        'tax_type' => 'string',
        'vendors' => '\SierraApi\Model\Vendor[]',
        'paid_date' => '\DateTime',
        'for_currency' => '\SierraApi\Model\ForeignCurrency',
        'inv_total' => '\SierraApi\Model\InvoiceTotal',
        'use_tax' => '\SierraApi\Model\UseTax',
        'line_items' => 'string[]'
    ];
     ...
     * Sets vendors
     *
     * @param \SierraApi\Model\Vendor[] $vendors a list of vendor details for the invoice
     *
     * @return $this
     */
     ...
     * Gets for_currency
     *
     * @return \SierraApi\Model\ForeignCurrency
     */
     ...
     * Sets for_currency
     *
     * @param \SierraApi\Model\ForeignCurrency $for_currency the invoice's foreign currency code, rate and format
     *
     * @return $this
     */
     ...
     * Gets inv_total
     *
     * @return \SierraApi\Model\InvoiceTotal
     */
     ...
     * Sets inv_total
     *
     * @param \SierraApi\Model\InvoiceTotal $inv_total the invoice totals
     *
     * @return $this
     */
     ...
     * Sets use_tax
     *
     * @param \SierraApi\Model\UseTax $use_tax the invoice's use tax percentage rate and fund
     *
     * @return $this
     */
