...
class Order implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order_date' => '\DateTime',
        'charged_funds' => '\SierraApi\Model\ChargedFund[]',
     ...
     * Gets charged_funds
     *
     * @return \SierraApi\Model\ChargedFund[]
     */
     ...
     * Sets charged_funds
     *
     * @param \SierraApi\Model\ChargedFund[] $charged_funds the list of funds to be charged and related data
     *
     * @return $this
     */
     ...
     * Sets fixed_fields
     *
     * @param \SierraApi\Model\map $fixed_fields the fixed-length fields from the order record
     *
     * @return $this
     */
     ...
     * Sets var_fields
     *
     * @param \SierraApi\Model\VarField[] $var_fields the variable-length fields from the order record
     *
     * @return $this
     */
