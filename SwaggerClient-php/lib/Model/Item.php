...
class Item implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'status' => '\SierraApi\Model\ItemStatus',
        'barcode' => 'string',
        'call_number' => 'string',
        'item_type' => 'string',
     ...
     * Sets location
     *
     * @param \SierraApi\Model\Location $location the location of the item, with the location code and name
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \SierraApi\Model\ItemStatus
     */
     ...
     * Sets status
     *
     * @param \SierraApi\Model\ItemStatus $status the status of the item, with the code and display value, and a due date if the item is checked out
     *
     * @return $this
     */
     ...
     * Sets fixed_fields
     *
     * @param \SierraApi\Model\map $fixed_fields the fixed-length fields from the item record
     *
     * @return $this
     */
     ...
     * Sets var_fields
     *
     * @param \SierraApi\Model\VarField[] $var_fields the variable-length fields from the item record
     *
     * @return $this
     */
