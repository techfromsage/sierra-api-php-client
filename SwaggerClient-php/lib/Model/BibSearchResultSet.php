...
class BibSearchResultSet implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'total' => 'int',
        'start' => 'int',
        'entries' => '\SierraApi\Model\BibSearchResultEntry[]'
    ];
     ...
     * Gets entries
     *
     * @return \SierraApi\Model\BibSearchResultEntry[]
     */
     ...
     * Sets entries
     *
     * @param \SierraApi\Model\BibSearchResultEntry[] $entries the search result entries in this set
     *
     * @return $this
     */
