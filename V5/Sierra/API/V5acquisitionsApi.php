...
class V5acquisitionsApi
{
     ...
     *
     * @param  \III\Sierra\V5\Models\AcquisitionOrderPost $acquisitionOrderPost the order information and the MARC records in: application/marc-json, application/marc-in-json or application/marc-xml (required)
     ...
     * @return \III\Sierra\V5\Models\OrderBibLinks
     */
    public function createANewAcquisition($acquisitionOrderPost, $acceptHeaderMimeType='')
    {
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\OrderBibLinks, HTTP status code, HTTP response headers (array of strings)
     */
    public function createANewAcquisitionWithHttpInfo($acquisitionOrderPost)
    {
        $returnType = '\III\Sierra\V5\Models\OrderBibLinks';
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\OrderBibLinks',
     ...
     */
    protected function createANewAcquisitionRequest($acquisitionOrderPost, array $headers=[])
    {
        // verify the required parameter 'acquisitionOrderPost' is set
        if ($acquisitionOrderPost === null || (is_array($acquisitionOrderPost) && count($acquisitionOrderPost) === 0)) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createANewAcquisition_0Request($login, $location, $fund, $vendor, $marc, $copies = null, $price = null, $acquisitionType = null, $claim = null, $code1 = null, $code2 = null, $code3 = null, $code4 = null, $format = null, $orderNote = null, $orderType = null, $raction = null, $rloc = null, $bloc = null, $status = null, $tloc = null, $odate = null, $language = null, $country = null, $note = null, $staffNote = null, $vendorNote = null, $vendorIDNumber = null, $volume = null, $selector = null, $vendorAccount = null, $currencyCode = null, $identity = null, $shipTo = null, $requestor = null, $oldOrderNumber = null, $paidNote = null, $vendorAddress = null, $customVarField1 = null, $customVarField2 = null, $customVarField3 = null, $customVarField4 = null, array $headers=[])
    {
        // verify the required parameter 'login' is set
        if ($login === null || (is_array($login) && count($login) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $login when calling createANewAcquisition_0'
            );
        }
        // verify the required parameter 'location' is set
        if ($location === null || (is_array($location) && count($location) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $location when calling createANewAcquisition_0'
            );
        }
        // verify the required parameter 'fund' is set
        if ($fund === null || (is_array($fund) && count($fund) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fund when calling createANewAcquisition_0'
            );
        }
        // verify the required parameter 'vendor' is set
        if ($vendor === null || (is_array($vendor) && count($vendor) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $vendor when calling createANewAcquisition_0'
            );
        }
        // verify the required parameter 'marc' is set
        if ($marc === null || (is_array($marc) && count($marc) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marc when calling createANewAcquisition_0'
            );
        }
     ...
     *
     * @param  \III\Sierra\V5\Models\AcquisitionOrder $acquisitionOrderPost the order information (required)
     * @param string $acceptHeaderMimeType Optional accept header mime type
     *
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function validateTheOrderData($acquisitionOrderPost, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function validateTheOrderDataRequest($acquisitionOrderPost, array $headers=[])
    {
        // verify the required parameter 'acquisitionOrderPost' is set
        if ($acquisitionOrderPost === null || (is_array($acquisitionOrderPost) && count($acquisitionOrderPost) === 0)) {
            throw new \InvalidArgumentException(
