...
class V5agenciesApi
{
     ...
     * @return \III\Sierra\V5\Models\AgencyResultSet
     */
    public function getAListOfAgencies($language = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
        list($response) = $this->getAListOfAgenciesWithHttpInfo($language);
        return $response;
    }

    /**
     * Operation getAListOfAgenciesWithHttpInfo
     *
     * Get a list of agencies
     *
     * @param  string $language an ISO 639-1 language code (default is en) (optional)
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\AgencyResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAListOfAgenciesWithHttpInfo($language = null)
    {
        $returnType = '\III\Sierra\V5\Models\AgencyResultSet';
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\AgencyResultSet',
    ...
    /**
     * Operation getAListOfAgenciesAsync
     *
     * Get a list of agencies
     *
     * @param  string $language an ISO 639-1 language code (default is en) (optional)
     ...
     */
    public function getAListOfAgenciesAsync($language = null)
    {
        return $this->getAListOfAgenciesAsyncWithHttpInfo($language)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAListOfAgenciesAsyncWithHttpInfo
     *
     * Get a list of agencies
     *
     * @param  string $language an ISO 639-1 language code (default is en) (optional)
    ...
    /**
     * Create request for operation 'getAListOfAgencies'
     *
     * @param  string $language an ISO 639-1 language code (default is en) (optional)
     ...
     */
    protected function getAListOfAgenciesRequest($language = null, array $headers=[])
    {
