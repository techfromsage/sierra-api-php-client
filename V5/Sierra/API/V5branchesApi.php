...
class V5branchesApi
{
     ...
     * @return \III\Sierra\V5\Models\Branch
     */
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\Branch, HTTP status code, HTTP response headers (array of strings)
     */
    public function getABranchByBranchIDWithHttpInfo($id, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\Branch';
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\BranchResultSet
     */
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\BranchResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAListOfBranchesWithHttpInfo($limit = null, $offset = null, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\BranchResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\BranchResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\Location[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getListOfPickupLocationsWithHttpInfo($language = null)
    {
        $returnType = '\III\Sierra\V5\Models\Location[]';
