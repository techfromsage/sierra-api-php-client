...
class V5authoritiesApi
{
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\AuthorityResultSet
     */
    public function getAListOfAuthorityRecords($limit = null, $offset = null, $id = null, $fields = null, $createdDate = null, $updatedDate = null, $deletedDate = null, $deleted = null, $suppressed = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\AuthorityResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\III\Sierra\V5\Models\AuthorityResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\AuthorityResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAListOfAuthorityRecordsRequest($limit = null, $offset = null, $id = null, $fields = null, $createdDate = null, $updatedDate = null, $deletedDate = null, $deleted = null, $suppressed = null, array $headers=[])
    {
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\Authority
     */
    public function getAnAuthorityRecordByRecordID($id, $fields = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\Authority, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnAuthorityRecordByRecordIDWithHttpInfo($id, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\Authority';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\Authority',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAnAuthorityRecordByRecordIDRequest($id, $fields = null, array $headers=[])
    {
     ...
     */
    public function getTheMARCDataForASingleAuthorityRecord($id, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTheMARCDataForASingleAuthorityRecordRequest($id, array $headers=[])
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
