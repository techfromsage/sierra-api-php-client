...
class VfundsApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getAListOfFundsWithHttpInfo ($login, $code, $fields);
        return $response; 
    }


    /**
     * getAListOfFundsWithHttpInfo
     *
     * Get a list of funds
     *
     * @param string $login the Sierra username associated with the fund records (required)
    ...
    public function getAListOfFundsWithHttpInfo($login, $code = null, $fields = null)
    {
        ...
        if ($login === null) {
            throw new \InvalidArgumentException('Missing the required parameter $login when calling getAListOfFunds');
        }
        ...
        if (is_array($code)) {
            $code = $this->apiClient->getSerializer()->serializeCollection($code, 'csv', true);
        }
