...
class V5invoicesApi
{
     ...
     * @return \III\Sierra\V5\Models\InvoiceLine
     */
    public function getALineItemRecordByLineID($login, $id, $fields = null, $acceptHeaderMimeType='')
    {
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\InvoiceLine, HTTP status code, HTTP response headers (array of strings)
     */
    public function getALineItemRecordByLineIDWithHttpInfo($login, $id, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\InvoiceLine';
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\InvoiceLine',
     ...
     */
    protected function getALineItemRecordByLineIDRequest($login, $id, $fields = null, array $headers=[])
    {
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\InvoiceResultSet
     */
    public function getAListOfInvoices($login, $limit = null, $offset = null, $id = null, $invNum = null, $statusCode = null, $fields = null, $invoiceDate = null, $createdDate = null, $updatedDate = null, $suppressed = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\InvoiceResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\III\Sierra\V5\Models\InvoiceResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\InvoiceResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAListOfInvoicesRequest($login, $limit = null, $offset = null, $id = null, $invNum = null, $statusCode = null, $fields = null, $invoiceDate = null, $createdDate = null, $updatedDate = null, $suppressed = null, array $headers=[])
    {
        // verify the required parameter 'login' is set
        if ($login === null || (is_array($login) && count($login) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\Invoice
     */
    public function getAnInvoiceByRecordID($login, $id, $fields = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\Invoice, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnInvoiceByRecordIDWithHttpInfo($login, $id, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\Invoice';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAnInvoiceByRecordIDRequest($login, $id, $fields = null, array $headers=[])
    {
        // verify the required parameter 'login' is set
        if ($login === null || (is_array($login) && count($login) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\InvoiceLineResultSet
     */
    public function getTheLineItemDataForASingleInvoiceRecord($login, $id, $fields = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\InvoiceLineResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTheLineItemDataForASingleInvoiceRecordWithHttpInfo($login, $id, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\InvoiceLineResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\InvoiceLineResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTheLineItemDataForASingleInvoiceRecordRequest($login, $id, $fields = null, array $headers=[])
    {
        // verify the required parameter 'login' is set
        if ($login === null || (is_array($login) && count($login) === 0)) {
            throw new \InvalidArgumentException(
