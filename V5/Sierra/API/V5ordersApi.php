...
class V5ordersApi
{
     ...
     */
    public function getAListOfOrders($limit = null, $offset = null, $id = null, $fields = null, $createdDate = null, $updatedDate = null, $deletedDate = null, $deleted = null, $suppressed = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAListOfOrdersRequest($limit = null, $offset = null, $id = null, $fields = null, $createdDate = null, $updatedDate = null, $deletedDate = null, $deleted = null, $suppressed = null, array $headers=[])
    {
     ...
     */
    public function getAnOrderByRecordID($id, $fields = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAnOrderByRecordIDRequest($id, $fields = null, array $headers=[])
    {
     ...
     */
    public function getThePropertiesOfAGivenFund($acctUnit, $fundCodeNum, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getThePropertiesOfAGivenFundRequest($acctUnit, $fundCodeNum, array $headers=[])
    {
        // verify the required parameter 'acctUnit' is set
        if ($acctUnit === null || (is_array($acctUnit) && count($acctUnit) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($fundCodeNum === null || (is_array($fundCodeNum) && count($fundCodeNum) === 0)) {
            throw new \InvalidArgumentException(
