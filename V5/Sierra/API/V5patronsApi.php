...
class V5patronsApi
{
     ...
     *
     * @param  \III\Sierra\V5\Models\PatronPatch $body post request (required)
     * @param string $acceptHeaderMimeType Optional accept header mime type
     *
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\PatronResult
     */
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\PatronResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAPatronRecordWithHttpInfo($body)
    {
        $returnType = '\III\Sierra\V5\Models\PatronResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\PatronResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\Patron
     */
    public function findAPatronByVarFieldFieldTagAndVarFieldContent($varFieldTag, $varFieldContent, $fields = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\Patron, HTTP status code, HTTP response headers (array of strings)
     */
    public function findAPatronByVarFieldFieldTagAndVarFieldContentWithHttpInfo($varFieldTag, $varFieldContent, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\Patron';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function findAPatronByVarFieldFieldTagAndVarFieldContentRequest($varFieldTag, $varFieldContent, $fields = null, array $headers=[])
    {
        // verify the required parameter 'varFieldTag' is set
        if ($varFieldTag === null || (is_array($varFieldTag) && count($varFieldTag) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($varFieldContent === null || (is_array($varFieldContent) && count($varFieldContent) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\Checkout
     */
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\Checkout, HTTP status code, HTTP response headers (array of strings)
     */
    public function getACheckoutByCheckoutIDWithHttpInfo($checkoutId, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\Checkout';
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\Fine
     */
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\Fine, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAFineRecordByFineIDWithHttpInfo($fineId, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\Fine';
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\Hold
     */
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\Hold, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAHoldRecordByHoldIDWithHttpInfo($holdId, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\Hold';
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\PatronResultSet
     */
    public function getAListOfPatrons($limit = null, $offset = null, $id = null, $fields = null, $createdDate = null, $updatedDate = null, $deletedDate = null, $deleted = null, $suppressed = null, $agencyCodes = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\PatronResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\III\Sierra\V5\Models\PatronResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\PatronResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAListOfPatronsRequest($limit = null, $offset = null, $id = null, $fields = null, $createdDate = null, $updatedDate = null, $deletedDate = null, $deleted = null, $suppressed = null, $agencyCodes = null, array $headers=[])
    {
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\CheckoutResultSet
     */
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\CheckoutResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCheckoutDataForASinglePatronRecordWithHttpInfo($id, $limit = null, $offset = null, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\CheckoutResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\CheckoutResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\CheckoutHistoryResultSet
     */
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\CheckoutHistoryResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\III\Sierra\V5\Models\CheckoutHistoryResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\CheckoutHistoryResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function getTheFinesDataForASinglePatronRecord($id, $limit = null, $offset = null, $fields = null, $assessedDate = null, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTheFinesDataForASinglePatronRecordRequest($id, $limit = null, $offset = null, $fields = null, $assessedDate = null, array $headers=[])
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V5\Models\HoldResultSet
     */
     ...
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V5\Models\HoldResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTheHoldsDataForASinglePatronRecordWithHttpInfo($id, $limit = null, $offset = null, $fields = null)
    {
        $returnType = '\III\Sierra\V5\Models\HoldResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V5\Models\HoldResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $holdId the hold record ID (required)
     * @param  \III\Sierra\V5\Models\PatronHoldPut $body the details of the hold (required)
     * @param  string $acceptLanguage the Accept-Language header (optional)
     * @param string $acceptHeaderMimeType Optional accept header mime type
     *
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     ...
     *
     * @param  int $id the patron record ID (required)
     * @param  \III\Sierra\V5\Models\PatronHoldPost $body details of the new hold (required)
     * @param string $acceptHeaderMimeType Optional accept header mime type
     *
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $id the patron record ID (required)
     * @param  \III\Sierra\V5\Models\PatronPatch $body patron request (required)
     * @param string $acceptHeaderMimeType Optional accept header mime type
     *
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \III\Sierra\V5\Models\PatronValidation $body post request (required)
     * @param string $acceptHeaderMimeType Optional accept header mime type
     *
     * @throws \III\Sierra\V5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
