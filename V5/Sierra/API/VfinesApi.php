...
class VfinesApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getAListOfFinesWithHttpInfo ($limit, $offset, $id, $fields, $assessedDate, $agencyCodes);
        return $response; 
    }


    /**
     * getAListOfFinesWithHttpInfo
     *
     * Get a list of fines
     *
     * @param int $limit the maximum number of results (optional)
