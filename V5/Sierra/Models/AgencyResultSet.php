...
/**
 * AgencyResultSet Class Doc Comment
 *
 * @category Class
 * @description a paged set of agency results
 * @package  III\Sierra\V5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AgencyResultSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AgencyResultSet';
    ...
    protected static $swaggerTypes = [
        'total' => 'int',
        'start' => 'int',
        'entries' => '\III\Sierra\V5\Models\Agency[]'
    ];
     ...
     * Gets entries
     *
     * @return \III\Sierra\V5\Models\Agency[]
     */
     ...
     * Sets entries
     *
     * @param \III\Sierra\V5\Models\Agency[] $entries the agency entries
     *
     * @return $this
     */
