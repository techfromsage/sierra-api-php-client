...
/**
 * PatronResultSet Class Doc Comment
 *
 * @category Class
 * @description a paged set of patron results
 * @package  III\Sierra\V5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PatronResultSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PatronResultSet';
    ...
    protected static $swaggerTypes = [
        'total' => 'int',
        'start' => 'int',
        'entries' => '\III\Sierra\V5\Models\Patron[]'
    ];
     ...
     * Sets entries
     *
     * @param \III\Sierra\V5\Models\Patron[] $entries the patron entries
     *
     * @return $this
     */
