...
class Hold implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'pickupLocation' => '\III\Sierra\V5\Models\Location',
        'status' => '\III\Sierra\V5\Models\HoldStatus',
        'recordType' => 'string',
        'priority' => 'int',
     ...
     * Sets location
     *
     * @param \III\Sierra\V5\Models\Location $location the code of the location from which to fill the hold, if the hold is set for \"Limit to Location\" (does not apply to item-level holds)
     *
     * @return $this
     */
     ...
     * Sets pickupLocation
     *
     * @param \III\Sierra\V5\Models\Location $pickupLocation the location code of the hold's pickup location
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \III\Sierra\V5\Models\HoldStatus
     */
     ...
     * Sets status
     *
     * @param \III\Sierra\V5\Models\HoldStatus $status the hold status code and description
     *
     * @return $this
     */
