...
class Bib implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'suppressed' => 'bool',
        'available' => 'bool',
        'lang' => '\III\Sierra\V5\Models\Language',
        'title' => 'string',
        'author' => 'string',
        'materialType' => '\III\Sierra\V5\Models\MaterialType',
        'bibLevel' => '\III\Sierra\V5\Models\BibLevel',
        'publishYear' => 'int',
        'catalogDate' => '\DateTime',
        'country' => '\III\Sierra\V5\Models\Country',
        'orders' => '\III\Sierra\V5\Models\OrderInfo[]',
        'normTitle' => 'string',
        'normAuthor' => 'string',
        'locations' => '\III\Sierra\V5\Models\Location[]',
     ...
     * Gets lang
     *
     * @return \III\Sierra\V5\Models\Language
     */
     ...
     * Sets lang
     *
     * @param \III\Sierra\V5\Models\Language $lang the language of the material (display value)
     *
     * @return $this
     */
     ...
     * Gets materialType
     *
     * @return \III\Sierra\V5\Models\MaterialType
     */
     ...
     * Sets materialType
     *
     * @param \III\Sierra\V5\Models\MaterialType $materialType the material type, such as book, serial, map, and so forth, based on MARC 21 Leader/06 values, or UNIMARC Label/06 values
     *
     * @return $this
     */
     ...
     * Gets bibLevel
     *
     * @return \III\Sierra\V5\Models\BibLevel
     */
     ...
     * Sets bibLevel
     *
     * @param \III\Sierra\V5\Models\BibLevel $bibLevel the bibliographic level, based on MARC 21 Leader/07 values or UNIMARC Label/07 values
     *
     * @return $this
     */
     ...
     * Gets country
     *
     * @return \III\Sierra\V5\Models\Country
     */
     ...
     * Sets country
     *
     * @param \III\Sierra\V5\Models\Country $country the country of publication (display value)
     *
     * @return $this
     */
     ...
     * Gets orders
     *
     * @return \III\Sierra\V5\Models\OrderInfo[]
     */
     ...
     * Sets orders
     *
     * @param \III\Sierra\V5\Models\OrderInfo[] $orders the order information for the bib record
     *
     * @return $this
     */
     ...
     * Sets locations
     *
     * @param \III\Sierra\V5\Models\Location[] $locations the locations associated with the bib
     *
     * @return $this
     */
     ...
     * Sets fixedFields
     *
     * @param \III\Sierra\V5\Models\map $fixedFields the fixed-length fields from the bib record
     *
     * @return $this
     */
     ...
     * Sets varFields
     *
     * @param \III\Sierra\V5\Models\VarField[] $varFields the variable-length fields from the bib record
     *
     * @return $this
     */
