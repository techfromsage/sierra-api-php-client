...
/**
 * InvoiceResultSet Class Doc Comment
 *
 * @category Class
 * @description a paged set of invoice results
 * @package  III\Sierra\V5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InvoiceResultSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InvoiceResultSet';
    ...
    protected static $swaggerTypes = [
        'total' => 'int',
        'start' => 'int',
        'entries' => '\III\Sierra\V5\Models\Invoice[]'
    ];
     ...
     * Sets entries
     *
     * @param \III\Sierra\V5\Models\Invoice[] $entries the invoice entries
     *
     * @return $this
     */
