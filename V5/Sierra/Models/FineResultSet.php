...
/**
 * FineResultSet Class Doc Comment
 *
 * @category Class
 * @description a paged set of fine results
 * @package  III\Sierra\V5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FineResultSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FineResultSet';
    ...
    protected static $swaggerTypes = [
        'total' => 'int',
        'start' => 'int',
        'entries' => '\III\Sierra\V5\Models\Fine[]'
    ];
     ...
     * Sets entries
     *
     * @param \III\Sierra\V5\Models\Fine[] $entries the fine entries
     *
     * @return $this
     */
