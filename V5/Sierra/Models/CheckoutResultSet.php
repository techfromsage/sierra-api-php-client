...
/**
 * CheckoutResultSet Class Doc Comment
 *
 * @category Class
 * @description a paged set of checkout results
 * @package  III\Sierra\V5
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CheckoutResultSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CheckoutResultSet';
    ...
    protected static $swaggerTypes = [
        'total' => 'int',
        'start' => 'int',
        'entries' => '\III\Sierra\V5\Models\Checkout[]'
    ];
     ...
     * Sets entries
     *
     * @param \III\Sierra\V5\Models\Checkout[] $entries the checkout entries
     *
     * @return $this
     */
