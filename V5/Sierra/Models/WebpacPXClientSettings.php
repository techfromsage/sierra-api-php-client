 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class WebpacPXClientSettings implements ArrayAccess
{
    /**
    ...
    /**
      * $host the WebPAC PX client host
      * @var string
      */
    protected $host;
    
    /**
      * $port the WebPAC PX client port
      * @var int
      */
    protected $port;
    
    /**
      * $urlContext the WebPAC PX client URL context
      * @var string
      */
    ...
    public function __construct(array $data = null)
    {
        if ($data != null) {
            $this->host = $data["host"];
            $this->port = $data["port"];
            $this->urlContext = $data["urlContext"];
        }
    }
