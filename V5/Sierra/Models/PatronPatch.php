...
class PatronPatch implements ModelInterface, ArrayAccess
{
     ...
     * Sets addresses
     *
     * @param \III\Sierra\V5\Models\Address[] $addresses a list of the patron's addresses (must include all applicable addresses for the patron)
     *
     * @return $this
     */
     ...
     * Sets phones
     *
     * @param \III\Sierra\V5\Models\Phone[] $phones a list of the patron's phone numbers (must include all applicable phone numbers for the patron)
     *
     * @return $this
     */
     ...
     * Sets patronCodes
     *
     * @param \III\Sierra\V5\Models\Codes $patronCodes a list of patron codes
     *
     * @return $this
     */
