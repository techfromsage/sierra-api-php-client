...
class Order implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'orderDate' => '\DateTime',
        'chargedFunds' => '\III\Sierra\V4\Models\ChargedFund[]',
        'vendorTitles' => 'string[]',
     ...
     * Gets chargedFunds
     *
     * @return \III\Sierra\V4\Models\ChargedFund[]
     */
     ...
     * Sets chargedFunds
     *
     * @param \III\Sierra\V4\Models\ChargedFund[] $chargedFunds the list of funds to be charged and related data
     *
     * @return $this
     */
     ...
     * Sets fixedFields
     *
     * @param \III\Sierra\V4\Models\map $fixedFields the fixed-length fields from the order record
     *
     * @return $this
     */
     ...
     * Sets varFields
     *
     * @param \III\Sierra\V4\Models\VarField[] $varFields the variable-length fields from the order record
     *
     * @return $this
     */
