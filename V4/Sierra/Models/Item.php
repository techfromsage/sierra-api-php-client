...
class Item implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'status' => '\III\Sierra\V4\Models\ItemStatus',
        'barcode' => 'string',
        'callNumber' => 'string',
        'itemType' => 'string',
     ...
     * Sets location
     *
     * @param \III\Sierra\V4\Models\Location $location the location of the item, with the location code and name
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \III\Sierra\V4\Models\ItemStatus
     */
     ...
     * Sets status
     *
     * @param \III\Sierra\V4\Models\ItemStatus $status the status of the item, with the code and display value, and a due date if the item is checked out
     *
     * @return $this
     */
     ...
     * Sets fixedFields
     *
     * @param \III\Sierra\V4\Models\map $fixedFields the fixed-length fields from the item record
     *
     * @return $this
     */
     ...
     * Sets varFields
     *
     * @param \III\Sierra\V4\Models\VarField[] $varFields the variable-length fields from the item record
     *
     * @return $this
     */
