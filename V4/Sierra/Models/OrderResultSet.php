...
/**
 * OrderResultSet Class Doc Comment
 *
 * @category Class
 * @description a paged set of order results
 * @package  III\Sierra\V4
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderResultSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderResultSet';
    ...
    protected static $swaggerTypes = [
        'total' => 'int',
        'start' => 'int',
        'entries' => '\III\Sierra\V4\Models\Order[]'
    ];
     ...
     * Sets entries
     *
     * @param \III\Sierra\V4\Models\Order[] $entries the order entries
     *
     * @return $this
     */
