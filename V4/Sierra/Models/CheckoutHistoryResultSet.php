...
class CheckoutHistoryResultSet implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'total' => 'int',
        'start' => 'int',
        'entries' => '\III\Sierra\V4\Models\CheckoutHistory[]'
    ];
     ...
     * Gets entries
     *
     * @return \III\Sierra\V4\Models\CheckoutHistory[]
     */
     ...
     * Sets entries
     *
     * @param \III\Sierra\V4\Models\CheckoutHistory[] $entries the checkout entries
     *
     * @return $this
     */
