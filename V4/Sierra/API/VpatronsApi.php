...
class VpatronsApi
{
     ...
     */
    public function getAListOfPatrons($limit = null, $offset = null, $id = null, $fields = null, $createdDate = null, $updatedDate = null, $deletedDate = null, $deleted = null, $suppressed = null)
    {
        list($response, $statusCode, $httpHeader) = $this->getAListOfPatronsWithHttpInfo ($limit, $offset, $id, $fields, $createdDate, $updatedDate, $deletedDate, $deleted, $suppressed);
        return $response; 
    }
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     */
    public function getAPatronByBarcode($barcode, $fields = null)
    {
        list($response, $statusCode, $httpHeader) = $this->getAPatronByBarcodeWithHttpInfo ($barcode, $fields);
        return $response; 
    }


    /**
     * getAPatronByBarcodeWithHttpInfo
     *
     * Get a patron by barcode
     *
     * @param string $barcode the patron barcode (required)
    ...
    public function getAPatronByBarcodeWithHttpInfo($barcode, $fields = null)
    {
        ...
        if ($barcode === null) {
            throw new \InvalidArgumentException('Missing the required parameter $barcode when calling getAPatronByBarcode');
        }
        ...
        if ($barcode !== null) {
            $queryParams['barcode'] = $this->apiClient->getSerializer()->toQueryValue($barcode);
        }// query params
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getMetadataListWithHttpInfo ($fields, $language);
        return $response; 
    }


    /**
     * getMetadataListWithHttpInfo
     *
     * get metadata list
     *
     * @param string $fields list of comma separated metadata fields (optional)
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     */
    public function getTheFinesDataForASinglePatronRecord($id, $limit = null, $offset = null, $fields = null)
    {
        list($response, $statusCode, $httpHeader) = $this->getTheFinesDataForASinglePatronRecordWithHttpInfo ($id, $limit, $offset, $fields);
        return $response; 
    }
