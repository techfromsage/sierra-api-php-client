...
class VordersApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getAListOfOrdersWithHttpInfo ($limit, $offset, $id, $fields, $createdDate, $updatedDate, $deletedDate, $deleted, $suppressed);
        return $response; 
    }


    /**
     * getAListOfOrdersWithHttpInfo
     *
     * Get a list of orders
     *
     * @param int $limit the maximum number of results (optional)
     ...
     * @param bool $deleted whether to retrieve only deleted (true) or non-deleted (false) order records (optional)
     * @param bool $suppressed the suppressed flag value of order records to retrieve (optional)
     * @return Array of \Models\OrderResultSet, HTTP status code, HTTP response headers (array of strings)
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     */
    public function getAListOfOrdersWithHttpInfo($limit = null, $offset = null, $id = null, $fields = null, $createdDate = null, $updatedDate = null, $deletedDate = null, $deleted = null, $suppressed = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\Models\OrderResultSet'
            );
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Models\OrderResultSet', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Models\OrderResultSet', $e->getResponseHeaders());
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getThePropertiesOfAGivenFundWithHttpInfo ($acctUnit, $fundCodeNum);
        return $response; 
    }


    /**
     * getThePropertiesOfAGivenFundWithHttpInfo
     *
     * Get the properties of a given Fund
     *
     * @param int $acctUnit the associated accounting unit (required)
     * @param int $fundCodeNum the fund code number (required)
     * @return Array of \Models\Fund, HTTP status code, HTTP response headers (array of strings)
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     */
    public function getThePropertiesOfAGivenFundWithHttpInfo($acctUnit, $fundCodeNum)
    {
        ...
        if ($acctUnit === null) {
            throw new \InvalidArgumentException('Missing the required parameter $acctUnit when calling getThePropertiesOfAGivenFund');
        }
        // verify the required parameter 'fundCodeNum' is set
        if ($fundCodeNum === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fundCodeNum when calling getThePropertiesOfAGivenFund');
        }
        ...
        if ($acctUnit !== null) {
            $resourcePath = str_replace(
                "{" . "acctUnit" . "}",
                $this->apiClient->getSerializer()->toPathValue($acctUnit),
                $resourcePath
            );
        }// path params
        ...
        if ($fundCodeNum !== null) {
            $resourcePath = str_replace(
                "{" . "fundCodeNum" . "}",
                $this->apiClient->getSerializer()->toPathValue($fundCodeNum),
                $resourcePath
            );
        }
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Models\Fund', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Models\Fund', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getAnOrderByRecordIDWithHttpInfo ($id, $fields);
        return $response; 
    }


    /**
     * getAnOrderByRecordIDWithHttpInfo
     *
     * Get an order by record ID
     *
     * @param int $id the order record ID (required)
     * @param string[] $fields a comma-delimited list of fields to retrieve (optional)
     * @return Array of \Models\Order, HTTP status code, HTTP response headers (array of strings)
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     */
    public function getAnOrderByRecordIDWithHttpInfo($id, $fields = null)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getAnOrderByRecordID');
        }
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Models\Order', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            default:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Models\Order', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
