...
/**
 * VbibsmarcfilesApi Class Doc Comment
 *
 * @category Class
 * @package  III\Sierra\V4
 * @author   http://github.com/swagger-api/swagger-codegen
...
class VbibsmarcfilesApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->findBibInformationUsingAWSSearchByAuthorAndorTitleWithHttpInfo ($index, $text, $limit, $offset, $fields);
        return $response; 
    }


    /**
     * findBibInformationUsingAWSSearchByAuthorAndorTitleWithHttpInfo
     *
     * Find bib information using AWS search by author and/or title
     *
     * @param string $index keyword index to be searched (required)
    ...
    public function findBibInformationUsingAWSSearchByAuthorAndorTitleWithHttpInfo($index, $text, $limit = null, $offset = null, $fields = null)
    {
        ...
        if ($index === null) {
            throw new \InvalidArgumentException('Missing the required parameter $index when calling findBibInformationUsingAWSSearchByAuthorAndorTitle');
        }
        // verify the required parameter 'text' is set
        if ($text === null) {
            throw new \InvalidArgumentException('Missing the required parameter $text when calling findBibInformationUsingAWSSearchByAuthorAndorTitle');
        }
