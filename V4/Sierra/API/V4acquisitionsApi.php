...
class V4acquisitionsApi
{
     ...
     * @return \III\Sierra\V4\Models\OrderBibLinks
     */
    public function createANewAcquisition_0($acquisitionOrderPost, $acceptHeaderMimeType='')
    {
        $this->headerSelector->setAcceptHeaderMimeType($acceptHeaderMimeType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createANewAcquisition_0Request($acquisitionOrderPost, array $headers=[])
    {
