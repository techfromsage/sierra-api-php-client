...
class V4authoritiesApi
{
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V4\Models\AuthorityResultSet
     */
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V4\Models\AuthorityResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\III\Sierra\V4\Models\AuthorityResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V4\Models\AuthorityResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V4\Models\Authority
     */
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V4\Models\Authority, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnAuthorityRecordByRecordIDWithHttpInfo($id, $fields = null)
    {
        $returnType = '\III\Sierra\V4\Models\Authority';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V4\Models\Authority',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
