...
class V4ordersApi
{
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V4\Models\OrderResultSet
     */
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V4\Models\OrderResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\III\Sierra\V4\Models\OrderResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V4\Models\OrderResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V4\Models\Order
     */
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V4\Models\Order, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnOrderByRecordIDWithHttpInfo($id, $fields = null)
    {
        $returnType = '\III\Sierra\V4\Models\Order';
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V4\Models\Fund
     */
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V4\Models\Fund, HTTP status code, HTTP response headers (array of strings)
     */
    public function getThePropertiesOfAGivenFundWithHttpInfo($acctUnit, $fundCodeNum)
    {
        $returnType = '\III\Sierra\V4\Models\Fund';
    ...
    protected function getThePropertiesOfAGivenFundRequest($acctUnit, $fundCodeNum, array $headers=[])
    {
        ...
        $resourcePath = '/v4/orders/funds/{acctUnit}/{fundCodeNum}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
