...
class V4itemsApi
{
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V4\Models\ItemResultSet
     */
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V4\Models\ItemResultSet, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\III\Sierra\V4\Models\ItemResultSet';
        ...
        try {
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\III\Sierra\V4\Models\ItemResultSet',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \III\Sierra\V4\Models\Item
     */
     ...
     * @throws \III\Sierra\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \III\Sierra\V4\Models\Item, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnItemByRecordIDWithHttpInfo($id, $fields = null)
    {
        $returnType = '\III\Sierra\V4\Models\Item';
