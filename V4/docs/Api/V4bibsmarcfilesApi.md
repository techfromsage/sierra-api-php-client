# III\Sierra\V4\V4bibsmarcfilesApi
...
$apiInstance = new III\Sierra\V4\Api\V4bibsmarcfilesApi(
...
> \III\Sierra\V4\Models\BibSearchResultSet findBibInformationUsingAWSSearchByAuthorAndorTitle($index, $text, $limit, $offset, $fields)
...
[**\III\Sierra\V4\Models\BibSearchResultSet**](../Model/BibSearchResultSet.md)
...
> \III\Sierra\V4\Models\MarcSummary generateABinaryMARCDataFileOfBibs($limit, $id, $mapping)
...
[**\III\Sierra\V4\Models\MarcSummary**](../Model/MarcSummary.md)
...
# **getABibByRecordID**
> \III\Sierra\V4\Models\Bib getABibByRecordID($id, $fields)
...
[**\III\Sierra\V4\Models\Bib**](../Model/Bib.md)
...
# **getAListOfBibs**
> \III\Sierra\V4\Models\BibResultSet getAListOfBibs($limit, $offset, $id, $fields, $createdDate, $updatedDate, $deletedDate, $deleted, $suppressed, $locations)
...
[**\III\Sierra\V4\Models\BibResultSet**](../Model/BibResultSet.md)
...
> \III\Sierra\V4\Models\ErrorCode getTheMARCDataForASingleBibRecord($id)
