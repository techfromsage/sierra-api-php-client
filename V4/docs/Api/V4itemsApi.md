...
$apiInstance = new III\Sierra\V4\Api\V4itemsApi(
...
# **getAListOfItems**
> \III\Sierra\V4\Models\ItemResultSet getAListOfItems($limit, $offset, $id, $fields, $createdDate, $updatedDate, $deletedDate, $deleted, $bibIds, $status, $duedate, $suppressed, $locations)
...
[**\III\Sierra\V4\Models\ItemResultSet**](../Model/ItemResultSet.md)
...
# **getAnItemByRecordID**
> \III\Sierra\V4\Models\Item getAnItemByRecordID($id, $fields)
...
[**\III\Sierra\V4\Models\Item**](../Model/Item.md)
